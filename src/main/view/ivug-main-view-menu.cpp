...
//		snprintf(edc_path, 100,"%s/res/edje/%s/ivug-icons.edj", PREFIX, PACKAGE);
		elm_image_file_set(icon, EDJ_PATH"/ivug-icons.edj", item->iconpath);
...
//			snprintf(edc_path, 100,"%s/res/edje/%s/ivug-icons.edj", PREFIX,PACKAGE);
			...
			elm_image_file_set(icon, EDJ_PATH"/ivug-icons.edj", ((Ivug_ListPopup_Item *)pItem)->iconpath);
...
//			snprintf(edc_path, 100, "%s/res/edje/%s/ivug-icons.edj", PREFIX, PACKAGE);
			...
			elm_image_file_set(icon, EDJ_PATH"/ivug-icons.edj", "icon.mainmenu.transparent");
