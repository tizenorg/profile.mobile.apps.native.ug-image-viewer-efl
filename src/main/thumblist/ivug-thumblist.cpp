...
#define EDJ_THUMBLIST 	PREFIX"/res/edje/ivug-thumblist.edj"
#define EDJ_ICON 		PREFIX"/res/edje/ivug-icons.edj"
...
#define INVALID_IMAGE (PREFIX"/res/images/T01_Nocontents_broken.png")
