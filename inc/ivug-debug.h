...
#define MSG_IMAGEVIEW_FATAL(...) 		dlog_print(DLOG_FATAL, LOG_TAG, ##__VA_ARGS__)//__MSG_FATAL(LVL_IVCOMMON, IVCOMMON_SZ, ##__VA_ARGS__)
#define MSG_IMAGEVIEW_ERROR(...)		dlog_print(DLOG_ERROR, LOG_TAG, ##__VA_ARGS__)//__MSG_ERROR(LVL_IVCOMMON, IVCOMMON_SZ, ##__VA_ARGS__)
#define MSG_IMAGEVIEW_WARN(...)			dlog_print(DLOG_WARN, LOG_TAG, ##__VA_ARGS__)//__MSG_WARN(LVL_IVCOMMON, IVCOMMON_SZ, ##__VA_ARGS__)
#define MSG_IMAGEVIEW_SEC(...)			dlog_print(DLOG_DEBUG, LOG_TAG, ##__VA_ARGS__)//__MSG_SEC(LVL_IVCOMMON, IVCOMMON_SZ, ##__VA_ARGS__)
#define MSG_IMAGEVIEW_HIGH(...)			dlog_print(DLOG_DEBUG, LOG_TAG, ##__VA_ARGS__)//__MSG_HIGH(LVL_IVCOMMON, IVCOMMON_SZ, ##__VA_ARGS__)
#define MSG_IMAGEVIEW_MED(...)			dlog_print(DLOG_DEBUG, LOG_TAG, ##__VA_ARGS__)//__MSG_MED(LVL_IVCOMMON, IVCOMMON_SZ, ##__VA_ARGS__)
#define MSG_IMAGEVIEW_LOW(...)			dlog_print(DLOG_DEBUG, LOG_TAG, ##__VA_ARGS__)//__MSG_LOW(LVL_IVCOMMON, IVCOMMON_SZ, ##__VA_ARGS__)

#define MSG_IVUG_FATAL(...) 			dlog_print(DLOG_FATAL, LOG_TAG, ##__VA_ARGS__)//__MSG_FATAL(LVL_IVCOMMON, IVCOMMON_SZ, ##__VA_ARGS__)
#define MSG_IVUG_ERROR(...)				dlog_print(DLOG_ERROR, LOG_TAG, ##__VA_ARGS__)//__MSG_ERROR(LVL_IVCOMMON, IVCOMMON_SZ, ##__VA_ARGS__)
#define MSG_IVUG_WARN(...)				dlog_print(DLOG_WARN, LOG_TAG, ##__VA_ARGS__)//__MSG_WARN(LVL_IVCOMMON, IVCOMMON_SZ, ##__VA_ARGS__)
#define MSG_IVUG_SEC(...)				dlog_print(DLOG_DEBUG, LOG_TAG, ##__VA_ARGS__)//__MSG_SEC(LVL_IVCOMMON, IVCOMMON_SZ, ##__VA_ARGS__)
#define MSG_IVUG_HIGH(...)				dlog_print(DLOG_DEBUG, LOG_TAG, ##__VA_ARGS__)//__MSG_HIGH(LVL_IVCOMMON, IVCOMMON_SZ, ##__VA_ARGS__)
#define MSG_IVUG_MED(...)				dlog_print(DLOG_DEBUG, LOG_TAG, ##__VA_ARGS__)//__MSG_MED(LVL_IVCOMMON, IVCOMMON_SZ, ##__VA_ARGS__)
#define MSG_IVUG_LOW(...)				dlog_print(DLOG_DEBUG, LOG_TAG, ##__VA_ARGS__)//__MSG_LOW(LVL_IVCOMMON, IVCOMMON_SZ, ##__VA_ARGS__)
...
#define MSG_MAIN_FATAL(...) 		dlog_print(DLOG_FATAL, LOG_TAG, ##__VA_ARGS__)//__MSG_FATAL(LVL_MAINVIEW, MAINVIEW_SZ, ##__VA_ARGS__)
#define MSG_MAIN_ERROR(...)			dlog_print(DLOG_ERROR, LOG_TAG, ##__VA_ARGS__)//__MSG_ERROR(LVL_MAINVIEW, MAINVIEW_SZ, ##__VA_ARGS__)
#define MSG_MAIN_WARN(...)			dlog_print(DLOG_WARN, LOG_TAG, ##__VA_ARGS__)//__MSG_WARN(LVL_MAINVIEW, MAINVIEW_SZ, ##__VA_ARGS__)
#define MSG_MAIN_SEC(...)			dlog_print(DLOG_DEBUG, LOG_TAG, ##__VA_ARGS__)//__MSG_SEC(LVL_MAINVIEW, MAINVIEW_SZ, ##__VA_ARGS__)
#define MSG_MAIN_HIGH(...)			dlog_print(DLOG_DEBUG, LOG_TAG, ##__VA_ARGS__)//__MSG_HIGH(LVL_MAINVIEW, MAINVIEW_SZ, ##__VA_ARGS__)
#define MSG_MAIN_MED(...)			dlog_print(DLOG_DEBUG, LOG_TAG, ##__VA_ARGS__)//__MSG_MED(LVL_MAINVIEW, MAINVIEW_SZ, ##__VA_ARGS__)
#define MSG_MAIN_LOW(...)			dlog_print(DLOG_DEBUG, LOG_TAG, ##__VA_ARGS__)//__MSG_LOW(LVL_MAINVIEW, MAINVIEW_SZ, ##__VA_ARGS__)
...
#define MSG_FATAL(...) 	dlog_print(DLOG_FATAL, LOG_TAG, ##__VA_ARGS__)
#define MSG_ERROR(...) 	dlog_print(DLOG_ERROR, LOG_TAG, ##__VA_ARGS__)
#define MSG_WARN(...) 	dlog_print(DLOG_WARN, LOG_TAG, ##__VA_ARGS__)
#define MSG_SEC(...) 	dlog_print(DLOG_DEBUG, LOG_TAG, ##__VA_ARGS__)
#define MSG_HIGH(...)	dlog_print(DLOG_DEBUG, LOG_TAG, ##__VA_ARGS__)
#define MSG_MED(...)	dlog_print(DLOG_DEBUG, LOG_TAG, ##__VA_ARGS__)
#define MSG_LOW(...)	dlog_print(DLOG_DEBUG, LOG_TAG, ##__VA_ARGS__)
#define MSG_DEBUG(...)	dlog_print(DLOG_DEBUG, LOG_TAG, ##__VA_ARGS__)
